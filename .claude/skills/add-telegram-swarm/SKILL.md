...
Must restart because the service env vars changed.
...
7. Remove `TELEGRAM_BOT_POOL` from `.env`, `data/env/env`, and systemd unit
8. Rebuild: `npm run build && ./container/build.sh && systemctl --user restart nanoclaw`
